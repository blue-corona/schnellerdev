 <div class="swiper-container bc_hero_swiper">
    <div class="swiper-wrapper">
        <div class="swiper-slide">
                ...
                <div class="hero-overlay-gradient-one">
                    <div class="container px-4 pt-4">
                        <div class="row text-center text-lg-left text-md-left">
                            <div class="col-md-6 col-xs-12 col-lg-6 col-sm-12 m-auto">
                                ...
                                <button onclick="window.location.href = '<?php echo get_home_url().bc_get_theme_mod('bc_theme_home_options', 'image_slider', 'bc_button_link_one', '/promotions')?>';" class="btn bc_color_secondary text-capitalize bc_color_primary_bg py-2 mt-2 hero-slide-one"> <?php echo bc_get_theme_mod('bc_theme_home_options', 'image_slider', 'bc_button_text_one', 'Schedule Service Today');?> &nbsp;<i aria-hidden="true" class="fa fa-chevron-circle-right"></i></button>
                    ...
                    <div class="container px-4 pt-4">
                        <div class="row text-center text-lg-left text-md-left">
                            <div class="col-md-6 col-xs-12 col-lg-6 col-sm-12 m-auto">
                                ...
                                <button onclick="window.location.href = '<?php echo get_home_url().bc_get_theme_mod('bc_theme_home_options', 'image_slider', 'bc_button_link_two', '/promotions')?>';" class="btn bc_color_secondary text-capitalize bc_color_primary_bg py-2 mt-2 hero-slide-two"> <?php echo bc_get_theme_mod('bc_theme_home_options', 'image_slider', 'bc_button_text_two', 'Schedule Service Today');?> &nbsp;<i aria-hidden="true" class="fa fa-chevron-circle-right"></i></button>
                            ...
                            <div class="col-md-6 col-xs-12 col-lg-6 col-sm-12 p-4">
                                <div class=" col-md-12 col-lg-9 col-sm-12 col-xs-12 offset-lg-2">
                                    <div class="bc_color_info_bg d-flex py-3 px-4">
                                         <div class="m-auto">
                                            <img alt="icon" class="img-fluid align-self-center mt-n3" src="<?php echo get_template_directory_uri();?>/img/24icon.png">
                                            <h2 class="bc_color_secondary text-capitalize text-capitalize bc_text_30 bc_font_alt_1 text-center  pt-1">
                                                Emergency Service
                                            </h2>
                                        </div>
                                    </div>
                    ...
                    <div class="container px-4 pt-4">
                        <div class="row text-center text-lg-left text-md-left">
                            <div class="col-md-6 col-xs-12 col-lg-6 col-sm-12 m-auto">
                                ...
                                <button onclick="window.location.href = '<?php echo get_home_url().bc_get_theme_mod('bc_theme_home_options', 'image_slider', 'bc_button_link_three', '/promotions')?>';" class="btn bc_color_secondary text-capitalize bc_color_primary_bg py-2 mt-2 hero-slide-three"> <?php echo bc_get_theme_mod('bc_theme_home_options', 'image_slider', 'bc_button_text_three', 'Schedule Service Today');?> &nbsp;<i aria-hidden="true" class="fa fa-chevron-circle-right"></i></button>
